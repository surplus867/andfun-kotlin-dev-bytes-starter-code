...
class DevByteViewModel(application: Application) : AndroidViewModel(application) {
     ...
     *
     */
    // TODO(1) Create the database singleton
    // Define a data variable and assign it to getDatabase(), passing the application.
    private val database = getDatabase(application)
    // TODO(2) Create your repository
    // Define val videosRepository and assign it to a VideosRepository using the database singleton.
    private val videosRepository = VideosRepository(database)

    // TODO(3) Create an init block
